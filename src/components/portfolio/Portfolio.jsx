...
const projectData = [
  {
    ...
    description:
      "For my C++ final project, I made a short text based adventure game with ASCII graphics.",
    link: "https://github.com/liammatheson/CPP-Final-Project---Text-Based-Adventure-Game",
  },
  {
    id: 2,
    image: card2,
    ...
    description:
      "Dashboard gets simulated data from background threading. Alerts and reports are generated based on this data. Live weather information for Halifax, NS is displayed..",
    link: "https://github.com/liammatheson/PROG2200-W0494713-LIAM-MATHESON-FINAL-PROJECT",
  },
  {
    id: 3,
    image: card3,
